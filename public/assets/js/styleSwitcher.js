    ...
    var dlabSwitcher = `
        <div class="sidebar-right">
            ...
            <div class="sidebar-right-inner">
                <h4>
                    Pick your style<a href="javascript:void(0);" onclick="deleteAllCookie()" class="btn btn-primary btn-sm pull-right">Delete All Cookie</a>
                </h4>
                <div class="card-tabs">
                        ...
                        <div class="admin-settings">
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="themecolor-bg">
                                        <span>
                                            <input class="chk-col-primary filled-in" id="themecolor_1" name="themecolor_bg" type="radio" value="theme_1">
                                            <label for="themecolor_1" class="theme-bg"></label>
                                        </span>
                                        <span>
                                            <input class="chk-col-primary filled-in" id="themecolor_2" name="themecolor_bg" type="radio" value="theme_2">
                                            <label for="themecolor_2" class="theme-bg"></label>
                                        </span>
                                        <span>
                                            <input class="chk-col-primary filled-in" id="themecolor_4" name="themecolor_bg" type="radio" value="theme_4">
                                            <label for="themecolor_4" class="theme-bg"></label>
                                        </span>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <p>Set Sidebar Image</p>
                                    <div class="navigation-bg flex-wrap">
                                        <span>
                                            <input class="chk-col-primary filled-in" id="sidebar_img_1" name="sidebar_img_bg" type="radio" value="assets/images/sidebar-img/1.jpg">
                                            <label for="sidebar_img_1" class="bg-image-sidebar"></label>
                                        </span>
                                        <span>
                                            <input class="chk-col-primary filled-in" id="sidebar_img_2" name="sidebar_img_bg" type="radio" value="assets/images/sidebar-img/2.jpg">
                                            <label for="sidebar_img_2" class="bg-image-sidebar"></label>
                                        </span>
                                        <span>
                                            <input class="chk-col-primary filled-in" id="sidebar_img_3" name="sidebar_img_bg" type="radio" value="assets/images/sidebar-img/3.jpg">
                                            <label for="sidebar_img_3" class="bg-image-sidebar"></label>
                                        </span>
                                        <span>
                                            <input class="chk-col-primary filled-in" id="sidebar_img_5" name="sidebar_img_bg" type="radio" value="assets/images/sidebar-img/5.jpg">
                                            <label for="sidebar_img_5" class="bg-image-sidebar"></label>
                                        </span>
                                        <a href="javascript:void(0)" class="btn btn-primary btn-sm remove-img">Remove Image</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="admin-settings">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <select class="default-select form-control wide" id="theme_layout" name="theme_layout">
                                        <option value="Choose Layout">Choose Layout</option>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="default-select form-control wide" id="header_position" name="header_position">
                                        <option value="Choose Header Positon">Choose Header Positon</option>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="default-select form-control wide" id="sidebar_style" name="sidebar_style">
                                        <option value="Choose Sidebar">Choose Sidebar</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class="default-select form-control wide" id="sidebar_position" name="sidebar_position">
                                    <option value="Choose Sidebar Position">Choose Sidebar Position</option>
                                    <option value="static">Static</option>
                                    <option value="fixed">Fixed</option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <select class="default-select form-control wide" id="container_layout" name="container_layout">
                                    <option value="Choose Container">Choose Container</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class="default-select form-control wide" id="typography" name="typography">
                                    <option value="Choose Font">Choose Font</option>
        ...
        <div class="note-text">
            ...
            <a href="https://dolab.dexignlab.com/doc/" target="_blank" class="doc">documentation.</a>
        </div>
    </div>`;
    ...
    <div class="dlab-demo-panel">
        ...
        <div class="dlab-demo-inner">
            ...
            <div class="fs-12 pt-3">
                <span class="text-danger">*Note :</span>
                This theme switcher is not part of product. It is only for demo. you will get all guideline in documentation. please check
                <a href="https://dolab.dexignlab.com/doc/" class="text-primary">documentation.</a>
            </div>
        </div>
    </div>`;
