...
<body class="body  h-100">
									...
									<div class="text-center my-5">
										<div class="logo">
                                            ...
                                            <div class="text-start d-grid" style="margin-top: -8px;">
                                                <h1 class="ms-2" style="font-size: 22px; letter-spacing: 10px; font-weight: 700;">FTS</h1>
                                                <span class="ms-2" style="font-size: 17px; margin-top: -15px;">Scan Absensi Pembelajaran</span> 
                                            </div>
										</div>
									</div> 
							...
							<div class="col-xl-6 col-md-6">
								<div class="sign-in-your" style="margin-top: 25%;"> 
									<form class="form mt-5" method="post" enctype="multipart/form-data"> 
										...
										<div class="mb-3 mb-0">
											<label class="radio-inline me-3"><input value="0" type="radio" name="status_absen">Tidak Hadir</label>
											<label class="radio-inline me-3"><input checked value="1" type="radio" name="status_absen">Hadir</label> 
											<label class="radio-inline me-3"><input checked value="2" type="radio" name="status_absen">Sakit/Izin</label> 
										</div> 
										 
										<div id="reader" style="width: 100%"></div>

										<div class="text-center mt-3">
											<button id="generate" type="submit" class="btn btn-primary btn-block">Generate</button> 
										</div>
									</form>
								</div>
							</div> 
    ...
    ***********************************-->
    ...
    <script> 
        ...
        // SATELITE
        var MapBox = L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/satellite-streets-v10/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoiYW50aGluc3QxIiwiYSI6ImNpbXJ1aGRtYTAxOGl2aG00dTF4ZTBlcmcifQ.k95ENmlDX1roCRKSFlgCNw', {
        ...
        // STREET MAP 
        var worldmap = L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/light-v9/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoiYW50aGluc3QxIiwiYSI6IjNkYjRiZTdhNTg4NjMyMjg0NTQ2ODlhYjk4NjNmOTEyIn0.NktrsSF9BBKAN1USj5ftCw', {
            attribution: 'Imagery from <a href="http://mapbox.com/about/maps/">MapBox</a> &mdash; Map data &copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>',
            id: 'vzett'
        }).bringToBack();
