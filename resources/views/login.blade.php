									...
									<div class="text-center my-5">
										<div class="logo">
                                            ...
                                            <div class="text-start d-grid" style="margin-top: -8px;">
                                                ...
                                                <span class="ms-2" style="font-size: 17px; margin-top: -15px;">Capaian Profile Lulusan</span> 
                                            </div>
										</div>
									</div>
									<img src="{{ asset('assets/images/log.png') }}" class="education-img"></img>
								</div>	
							</div>
							<div class="col-xl-6 col-md-6">
								<div class="sign-in-your" style="margin-top: 25%;">
									<h3>Masuk ke akun Anda</h3>
									<span class="text-white">Selamat Datang kembali! Login dengan data diri yang <br>Anda masukkan saat registrasi</span>
									...
									<form class="form mt-5" method="post" enctype="multipart/form-data"> 
										<div class="mb-3">
											...
											<input type="email" name="email" class="form-control" placeholder="fts-cpl@example.com">
										</div>
										<div class="mb-3">
