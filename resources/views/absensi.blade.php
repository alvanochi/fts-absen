									...
									<div class="text-center my-5">
										<div class="logo">
                                            ...
                                            <div class="text-start d-grid" style="margin-top: -8px;">
                                                ...
                                                <span class="ms-2" style="font-size: 17px; margin-top: -15px;">Absensi Pembelajaran</span> 
                                            </div>
										</div>
									</div> 
								...
								<div class="sign-in-your" style="margin-top: 25%;">
									...
									<form class="form mt-5" method="post" enctype="multipart/form-data"> 
										...
										<div class="mb-3">
											...
											<input type="number" name="pertemuan" class="form-control" placeholder="Pertemuan" required>
										</div>
										<div class="mb-3">
										...
										<div class="mb-3 mb-0">
											<label class="radio-inline me-3"><input checked value="1" type="radio" name="status_kelas">Online</label> 
											<label class="radio-inline me-3"><input value="0" type="radio" name="status_kelas">Offline</label>
										</div>
										 
										<div class="text-center">
											<button id="generate" type="submit" class="btn btn-primary btn-block">Generate</button>
											<a id="showQr" data-bs-toggle="modal" data-bs-target="#qrModal" href="javascript:void(0)" class="btn btn-primary btn-block">Show Qr</a>
										</div>
									</form>
								</div>
							</div>
    ...
    <div class="modal fade bd-example-modal-sm" id="qrModal"> 
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
				...
				<div class="modal-footer text-center" style="justify-content: center; background-color: #000000; text-transform: uppercase;">
